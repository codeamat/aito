...
public class MissionList
{
	...
	{
		final List<MissionHolder> missions = MissionData.getInstance().getMission(type);
		...
		final MissionHolder missionData = MissionData.getInstance().getMissionByLevel(type, mission.getId() + 1);
	...
	{
		final Map<MissionType, List<MissionHolder>> missions = MissionData.getInstance().getMissions();
